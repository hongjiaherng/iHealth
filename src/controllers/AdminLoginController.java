...
import models.Admin;
import utils.Loggerr;
import utils.SessionManagerr;
...
public class AdminLoginController {
    ...
    private boolean validateLogin() throws IOException {
        ...
        if (validatedAdmin == null) {
            Loggerr.loginFailure(adminid);
            return false;
        }

        SessionManagerr.setSessionAdmin(validatedAdmin);
        Loggerr.loginSuccess(adminid);
        return true;
    }
}
